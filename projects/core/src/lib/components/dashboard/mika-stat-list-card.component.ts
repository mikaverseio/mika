...
import { IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonSpinner, IonNote, IonChip, IonIcon, IonBadge, IonList, IonItem, IonLabel } from '@ionic/angular/standalone';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, IonCard, IonIcon, IonCardContent, IonSpinner, IonNote, IonChip, TranslatePipe, TranslateModule, IonBadge, IonList, IonItem, IonLabel],
    template: `
...
export class MikaStatListCardComponent implements OnInit {
