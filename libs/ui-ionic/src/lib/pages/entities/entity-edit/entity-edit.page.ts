...
export class MikaEntityEditPage implements OnInit {
	...
	async ngOnInit() {
		...
		this.seo.setMetaTags({
			title: `${this.translate.instant('Mika')} - ${this.translate.instant('form-edit', {slug: this.translate.instant(this.entityConfig?.singular ?? 'item')})}`
		});
	}
