...
@Component({
	...
	imports: [
		...
		MatCheckboxModule, ReactiveFormsModule, FormsModule, MatDatepickerModule,
		MatFormFieldModule, MatInputModule, MatOption, MatSlideToggleModule, MatButtonModule, MatAutocompleteModule,
